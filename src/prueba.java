...
/**
 * @author Sammie This was the initial version, meanwhile I improved the
 * validation just loop once over all columns instead and create a bitmask for
 * fast checking instead of looping over all columns for all permutations O(C)
 * to O(1)
 */
public class prueba {
    ...
    public static void main(String[] args) throws Exception {
        File file = new File("src/archivos/notamusical.txt");
        final InputReader in = new InputReader(new FileInputStream(file));
